  ...
  public data: any[] = [
    {
      ...
      <h3>Qualifications &amp; Strengths</h3><ul><li>25+ Years Martial Arts Experience</li><li>10+ Years Teaching Experience</li><li>Muay Thai Kickboxing, Brazillian Jiu Jitsu, Catch Wrestling, Traditional Karate<br></li></ul>
      <h3>Hobbies</h3><ul><li>Marksmanship</li><li>Hiking and Camping</li><li>Teaching and working in the Community</li><li>Spending time with his wife, 
      Michele and daughter, Ryan</li></ul>`,
      blurb: "Owner, Founder",
    ...
    },
    {
      title: "Michele Young",
      tags: ["Owner"],
      content: `<p>Michele brings her many years of administrative and management skills to the team at Beyond the Belt. As a mother of a student, 
      Michele understands how the teachings of martial arts can positively impact kids by enhancing their life-skills and placing emphasis on their 
      values and attitudes. <br><br>She provides support for the entire BTB staff through her enthusiasm, professional demeanor and dedication. 
      Michele practices a healthy lifestyle through the Paleo diet, her enjoyment of yoga, hiking and fitness.<br></p>`,
      blurb: "Director",
    ...
    // },
    {
      ...
      tags: ["HeadInstructor"],
      content: `<p class="p1">Sensei Beth is one of the head instructors for our Laconia location. She brings a fiery energy to the dojo, be it 
      teaching classes, special events, meeting with parents, or working one on one with a student. In her free time, Sensei Beth loves fitness, 
      playing football, the arts, and practicing nunchucks. What Sensei Beth loves most about Beyond the Belt is the way it grows kids into 
      warriors and leaders. She is glad to be a part of something that encourages kids to do more, be more, and change the world for the better.</p>`,
    ...
    },
    {
      title: "Ethan Merrill",
      tags: ["Staff"],
      content: `<p>Coach Ethan is an upbeat and always energetic instructor at our Laconia location! He is always talking to students in the lobby 
      and pushing them to be their best in the dojo. Coach Ethan is a well versed martial artist who loves to train nunchucks, bo staff, is a 
      longtime member of the BTB Demo Team, and a solid training partner in our Adult MMA program. Outside of BTB, he also has done many Spartan 
      races and other obstacle course racing! He looks forward to seeing you in his classes!</p>`,
      blurb: "Instructor",
    ...
    },
    {
      title: "Eric Oswald",
      tags: ["Staff"],
      content: `<p>Coach Eric is an instructor at our Laconia location. He helps instructor our Beginner/Advanced Teen classes, but he is always 
      ready to jump in and lend a helping hand whenever a student needs assistance. He trains alongside his wife, Liz, and his daughter, Addy! He 
      hopes to see you in his classes soon!</p>`,
      blurb: "Instructor",
    ...
    },
    {
      title: "Briah Welch",
      tags: ["Staff"],
      content: `<p><span class="s1">Coach Briah is one of our instructors for our Center Harbor location. She is always ready to train and brings 
      a great positive energy that she shares with her students. She loves Center Harbor for it's tight knit family and can't wait to see you in 
      her classes!</span></p>`,
      blurb: "Instructor",
